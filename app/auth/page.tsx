      ...
      <section className="py-20 bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            >
              {[
                { icon: CheckCircle, title: "Secure", description: "Your data is encrypted and secure" },
                { icon: CheckCircle, title: "Fast", description: "Quick and easy authentication" },
                { icon: CheckCircle, title: "24/7 Support", description: "We're here to help anytime" }
              ].map((feature, i) => (
