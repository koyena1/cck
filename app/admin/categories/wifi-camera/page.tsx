  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">WiFi Camera Products</h1>
          <p className="text-gray-600 dark:text-gray-300 mt-1">Manage your WiFi Camera products</p>
        </div>
        <div className="flex items-center gap-3">
          <CategoryExcelUpload category="wifi-camera" onUploaded={fetchProducts} />
          <button
        ...
        <table className="min-w-full divide-y divide-gray-200 dark:divide-slate-700">
          <thead className="bg-gray-50 dark:bg-slate-800">
            <tr>
              ...
              <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">Connectivity</th>
              <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">Night Vision</th>
          ...
          <tbody className="bg-white dark:bg-slate-900 divide-y divide-gray-200 dark:divide-slate-700">
            {products.map((product) => (
              <tr key={product.id}>
                ...
                <td className="px-6 py-4 text-sm text-gray-900 dark:text-gray-100">{product.connectivity}</td>
                <td className="px-6 py-4 text-sm text-gray-900 dark:text-gray-100">{product.nightVision ? 'Yes' : 'No'}</td>
