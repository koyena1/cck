  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">HD Camera Products</h1>
          <p className="text-gray-600 mt-1">Manage your HD Camera products</p>
        </div>
        <button
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {products.map((product) => (
              <tr key={product.id}>
                ...
                <td className="px-6 py-4 text-sm text-gray-900">{product.lens}</td>
